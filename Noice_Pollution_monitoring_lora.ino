...
static const PROGMEM u1_t NWKSKEY[16] = {0x39, 0x63, 0xDD, 0xB5, 0x28, 0x8D, 0xBC, 0xA7, 0x64, 0xC3, 0x81, 0x3A, 0xEE, 0xF7, 0x05, 0x47};

// LoRaWAN AppSKey, application session key
static const u1_t PROGMEM APPSKEY[16] = {0x14, 0xA1, 0x43, 0x43, 0xDE, 0x8F, 0xE0, 0x05, 0x5C, 0xAD, 0xF9, 0x8E, 0x77, 0x53, 0xAA, 0x66};

// LoRaWAN end-device address (DevAddr)
static const u4_t DEVADDR = 0x260D4C30;

const int microphonePin1 = A0;  // 第一个声音传感器模拟输出连接的引脚


const unsigned long interval = 10000;  // 2秒间隔
...
void loop() {
  ...
  int microphoneValue1 = analogRead(microphonePin1);
  ...
  if (currentMillis - previousMillis >= interval) {
    int averageValue1 = total1 / count1;
    Serial.print("Sensor 1 Average: ");
    Serial.println(averageValue1);
    snprintf((char *)mydata, sizeof(mydata), "%d", averageValue1);
    count1 = 0;
    total1 = 0;
